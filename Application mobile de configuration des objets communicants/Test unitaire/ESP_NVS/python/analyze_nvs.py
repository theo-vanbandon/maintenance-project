# https://github.com/AFontaine79/Espressif-NVS-Analyzer
# Modifications Gwenael LAURENT à partir de la ligne 225
    ...
    while i < len(entry_states):
        ...
        if entry_states[i] == EntryState.WRITTEN:
            ...
            if entry_type < 0x20:
                ...
                #modif Gwen
                if entry_ns not in ns_idx_to_name:
                    ns_idx_to_name[entry_ns] = 'unknown'
                    nvs_table['unknown'] = {}
                    blob_reassembly_table['unknown'] = {}
                #fin modif Gwen
