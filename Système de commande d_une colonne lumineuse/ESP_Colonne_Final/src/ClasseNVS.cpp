...
String ClasseNVS::LireValeurStr(int prmIndex) {
    ...
    // switch (prmIndex) {
    // case 0:
    //     valeurAenvoyer = prefs.getString("TypeObjet");
    //     break;
    ...
    // case 2:
    //     valeurAenvoyer = Password;
    //     break;

    // case 3:
    //     valeurAenvoyer = UUID_Moteur;
    //     break;

    // case 5:
    //     valeurAenvoyer = UUID_Machine;
    //     break;
    ...
    if (prmIndex == 5) {
        valeurAenvoyer = prefs.getString("UUID_Machine", "DEFAULT");
    }
    prefs.end();
...
int ClasseNVS::LireValeurInt(int prmIndex) {
    ...
    if (prmIndex == 4) {
        valeurAenvoyer = prefs.getInt("TypeObjet", 80);
    }
